...
plotAB(ab.tA9,what="bias",col.agree="gray50", xlim=c(1,9), ylim=c(0,11), xlab= "Average", ylab="Reader 1")
title(ylab="Reader 1", line=2, cex.lab=1.4, family="Times")
legend("topleft", bty="n", border=NULL, paste("APE",round(Reader9.stats[1,8], 1), "\n", "CV", round(Reader9.stats[1,6], 1))) 

plotAB(ab.tA10,what="bias",col.agree="gray50", xlim=c(1,9), ylim=c(0,11), xlab= "Average", ylab="Reader 2")
legend("topleft", bty="n", border=NULL, paste("APE",round(Reader10.stats[1,8], 1), "\n", "CV", round(Reader10.stats[1,6], 1))) 

plotAB(ab.tA9,what="bias",col.agree="gray50", xlim=c(1,9), ylim=c(0,11), xlab= "Average", ylab="Reader 3")
legend("topleft", bty="n", border=NULL, paste("APE",round(Reader9.stats[1,8], 1), "\n", "CV", round(Reader9.stats[1,6], 1))) 

plotAB(ab.tA12,what="bias",col.agree="gray50", xlim=c(1,9), ylim=c(0,11), xlab= "Average" , ylab="Reader 4*")
legend("topleft", bty="n", paste("APE",round(kevin.stats[1,4], 3), "\n", "CV", round(kevin.stats[1,5], 3))) 
mtext("Reader Band Count Against Average Band Count \n for Spot Shrimp", side = 3, line = -3, outer = TRUE)
##############################
